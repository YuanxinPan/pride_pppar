...
if(ierr.ne.0) then
  write(oscr,'(2a)') '***ERROR(read_fcb): open file ',flnfcb(1:len_trim(flnfcb))
  call exit(1)
endif
!
!! read header
...
return
100 write(oscr,'(2a)') '***ERROR(read_fcb): end of file ',flnfcb(1:len_trim(flnfcb))
call exit(1)
200 write(oscr,'(2a)') '***ERROR(read_fcb): read file ',flnfcb(1:len_trim(flnfcb))
call exit(1)
end
