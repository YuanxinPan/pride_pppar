...
if(ierr1.ne.0) then
  write(*,'(2a)') '***ERROR(mergesp3): open file ',sp3fil1(1:len_trim(sp3fil1))
  call exit(1)
endif

if(ierr2.ne.0) then
  write(*,'(2a)') '***ERROR(mergesp3): open file ',sp3fil2(1:len_trim(sp3fil2))
  call exit(1)
endif

if(ierr3.ne.0) then
  write(*,'(2a)') '***ERROR(mergesp3): open file ',sp3fil3(1:len_trim(sp3fil3))
  call exit(1)
endif
