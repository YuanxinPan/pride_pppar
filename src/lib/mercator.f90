...
!
!! result
  xy(1) = bx + n*ti*((0.5d0 + (1.d0/24.d0*(5.d0 - ti**2 + 9.d0*ita2 + 4.d0*ita2**2) + &
          1.d0/72.d1*(61.d0 - 58.d0*ti**2 + ti**4)*m**2)*m**2)*m**2)
  xy(2) = n*((1.d0 + (1.d0/6.d0*(1.d0 - ti**2 + ita2) + 1.d0/120.d0* &
          (5.d0 - 18.d0*ti**2 + ti**4 + 14.d0*ita2 - 58.d0*ita2*ti**2)*m**2)*m**2)*m)
  return
end
