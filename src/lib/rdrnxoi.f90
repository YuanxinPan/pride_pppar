...
!
!! check time
if(im.le.0.or.im.gt.12.or.id.le.0.or.id.gt.31.or.ih.lt.0.or.ih.ge.24.or.imi.lt.0.or.imi.gt.60.or.sec.lt.0.d0.or.sec.gt.60.d0) then
...
write(oscr,'(a/a/a)') '***ERROR(rdrnxoi): read file, '//name(1:len_trim(name)),'   line :'//line(1:80),' &
  msg  :'//msg(1:len_trim(msg))
call exit(1)
!
...
do i=1,MAXSAT
  OB%obs(i,1:4)=0.d0
enddo           
write(oscr,'(a/a)') '###WARNING(rdrnxoi): end of file, ',name(1:len_trim(name))
return
end
