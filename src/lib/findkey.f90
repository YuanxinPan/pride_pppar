...
!! last mod.: 31-Aug-2003 by Maorong GE, add continous line
!
...
100 continue
findkey='EMPTY'
write(*,'(a)') '***WARNING(findkey): `'//keyword(1:len_trim(keyword))//'` not found.'
write(*,'(a)') '   bracket: ',sinex_bracket(1:len_trim(sinex_bracket))
return
end
