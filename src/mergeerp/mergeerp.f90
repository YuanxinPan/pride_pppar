...
if(ierr1.ne.0) then
  write(*,'(2a)') '***ERROR(mergeerp): open file ',erpfil1(1:len_trim(erpfil1))
  call exit(1)
endif

if(ierr2.ne.0) then
  write(*,'(2a)') '***ERROR(mergeerp): open file ',erpfil2(1:len_trim(erpfil2))
  call exit(1)
endif

if(ierr3.ne.0) then
  write(*,'(2a)') '***ERROR(mergeerp): open file ',erpfil3(1:len_trim(erpfil3))
  call exit(1)
endif
